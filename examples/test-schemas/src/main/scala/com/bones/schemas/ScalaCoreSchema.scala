...
object ScalaCoreSchema {
  ...
  val alg = new ScalaCoreSugar with Sugar[ScalaCoreValue]
  import alg._
  ...
  case class AllScalaCore(i: Int, l: Long, s: Short, b: Boolean, str: String, f: Float, e: TestEnum.Value, bd: BigDecimal, ba: Array[Byte])
