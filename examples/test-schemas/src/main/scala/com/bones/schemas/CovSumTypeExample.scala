...
//    type MusicMedium = Digital :+: CompactDisc :+: Album :+: CNil
  ...
  case class Album(name: String, albumQuality: Quality.Quality, coverQuality: Quality.Quality) extends MusicMedium
  ...
  case class CompactDisc(name: String, cdQuality: Quality.Quality, caseQuality: Quality.Quality) extends MusicMedium
