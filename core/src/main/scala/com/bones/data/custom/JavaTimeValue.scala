...
trait JavaTimeValueSugar {
  ...
  def monthDay(validationOp: ValidationOp[MonthDay]*): MonthDayData = MonthDayData(validationOp.toList)
  ...
  def offsetTime(validationOp: ValidationOp[OffsetTime]*): OffsetTimeData = OffsetTimeData(validationOp.toList)
  ...
  def yearMonth(validationOp: ValidationOp[YearMonth]*): YearMonthData = YearMonthData(validationOp.toList)
  ...
  def zoneOffset(validationOp: ValidationOp[ZoneOffset]*): ZoneOffsetData = ZoneOffsetData(validationOp.toList)
