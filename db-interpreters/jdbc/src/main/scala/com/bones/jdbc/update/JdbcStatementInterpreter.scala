...
trait JdbcStatementInterpreter[ALG[_]]
  ...
  ): Index => JdbcColumnStatement[C] = {
    value match {
      case _: KvpCoNil[String, ALG] =>
        i => JdbcColumnStatement[CNil](i, List.empty, _ => List.empty)
