...
import com.bones.data.custom.{BigDecimalData, BooleanData, ByteArrayData, DoubleData, EnumerationData, FloatData, IntData, LocalDateData, LocalDateTimeData, LocalTimeData, LongData, ScalaCoreValue, ShortData, StringData, UuidData}
