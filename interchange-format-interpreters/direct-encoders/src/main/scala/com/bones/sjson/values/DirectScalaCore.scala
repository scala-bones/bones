...
import com.bones.data.values.{BigDecimalData, BooleanData, ByteArrayData, DoubleData, EnumerationData, FloatData, IntData, LocalDateData, LocalDateTimeData, LocalTimeData, LongData, ScalaCoreValue, ShortData, StringData, UuidData}
